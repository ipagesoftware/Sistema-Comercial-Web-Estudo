    ...
    <div id="wrapper" <?php echo($layout->paddingLeft); ?>>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="jumbotron">
                    <h1 style="color: #ec8c8c;">Atenção, página não autorizada.</h1>                    
                    <?php
                      if(strlen($parameter)!=0){
                        echo('<p style="text-align: justify;">' . $parameter .'.</p>');    
                      }else{
                        echo('<p style="text-align: justify;">Usuário sem permissão para acessar a página do módulo: <strong>' . $modulo . '</strong>.</p>');
                      }
                    ?>
