    ...
    <div id="wrapper" <?php echo($layout->paddingLeft); ?>>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="jumbotron">
                    <h1 style="color: #ec8c8c;">Ops! Algo deu errado!</h1>
                    <p style="text-align: justify;">A URL requisitada não foi encontrada neste servidor. Se você digitou o endereço (URL) manualmente, por favor verifique novamente a sintaxe do endereço. Se você acredita ter encontrado um problema no servidor, por favor entre em contato com o webmaster.</p>                    
