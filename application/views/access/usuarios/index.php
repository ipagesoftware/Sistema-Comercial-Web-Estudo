...
<body data-criterio = "" data-right-button="<?= NO_RIGHT_MOUSE_BUTTON ?>" data-url="<?= URL ?>" data-accesskey ="<?= ACCESS_KEY ?>" data-acentuacao ="<?= ACENTUACAO ?>">
  ...
  <div id="wrapper" <?php echo($layout->paddingLeft); ?>>
      ...
      <div id="page-wrapper">
          <div class="container-fluid">
            <!-- Page Heading -->
            <?php
              echo($Usuarios->createLinkMenu());
            ?>
            <!-- /.row -->
            <div class="row">
                <div class="col-lg-12">                                         
                  <?php echo($Usuarios->insertDataIntoTable()); ?>
                </div>                
            </div>
            <!-- /.row -->
          </div>
  ...
  <!-- //--> 
  <script src="application/views/access/usuarios/js/UsuariosIndex.js" type="text/javascript"></script>
</body>
</html>
