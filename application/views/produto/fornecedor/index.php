...
<body data-criterio = "" data-right-button="<?= NO_RIGHT_MOUSE_BUTTON ?>" data-url="<?= URL ?>" data-accesskey ="<?= ACCESS_KEY ?>" data-acentuacao ="<?= ACENTUACAO ?>">
  ...
  <div id="wrapper" <?php echo($layout->paddingLeft); ?>>
      ...
      <div id="page-wrapper">
          <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Lista de Fornecedor <small> - <?php echo($Fornecedor->sid->getNode('procedencia_empresa')); ?></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <i class="fa fa-refresh"></i> <a href="fornecedor/">Atualizar</a>
                        </li>
                        <li>
                        ...
                        <li>
                        <?php
                          if($Fornecedor->permission['inserir']!=1){
                            echo('<i class="fa fa-ban"></i> Adicionar</a>'); 
                          }else{
                            echo('<i class="fa fa-plus"></i> <a href="fornecedor/addupdt/' . $layout->getParameter() .'">Adicionar</a>');
                          }
                        ?>
                        </li>                        
                    </ol>
            ...
            <div class="row">
                <div class="col-lg-12">                                         
                  <?php echo($Fornecedor->insertDataIntoTable()); ?>
                </div>                
            </div>
            <!-- /.row -->
          </div>
  ...
  <script src="application/views/produto/fornecedor/js/FornecedorIndex.js" type="text/javascript"></script>
</body>
</html>
