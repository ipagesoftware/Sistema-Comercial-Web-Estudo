...
<body data-criterio = "" data-right-button="<?= NO_RIGHT_MOUSE_BUTTON ?>" data-url="<?= URL ?>" data-accesskey ="<?= ACCESS_KEY ?>" data-acentuacao ="<?= ACENTUACAO ?>">
  ...
  <div id="wrapper" <?php echo($layout->paddingLeft); ?>>
      ...
      <div id="page-wrapper">
          <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Lista Unidade Medida  <small> - <?php echo($layout->sid->getNode('procedencia_empresa'));?> </small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <i class="fa fa-refresh"></i> <a href="application/views/produto/um/">Atualizar</a>
                        </li>
                        <li>
                        ...
                        <li>
                        <?php
                          if($UmIndex->permission['inserir']!=1){
                            echo('<i class="fa fa-ban"></i> Adicionar</a>'); 
                          }else{
                            echo('<i class="fa fa-plus"></i> <a href="application/views/produto/um/addupdt.php">Adicionar</a>');
                          }
                        ?>
                        </li>                        
                    </ol>
            ...
            <div class="row">
                <div class="col-lg-12">                                         
                  <?php echo($UmIndex->insertDataIntoTable()); ?>
                </div>                
            </div>
            <!-- /.row -->
          </div>
  ...
  <!-- //-->
  <script src="application/views/produto/um/js/UmIndex.js" type="text/javascript"></script>
</body>
</html>
