...
/**
 * [Grupo_Modal description]
 */
var GrupoModal = function() {
    // Variáveis privadas
  ...
  return{
    init: function(par) {
        $("#form1").attr("action", "javascript:GrupoModal.submitForm();void(0);");
        handleMask();
        //
    ...
    submitForm: function() {
        ...
        //
        return GrupoModal.saveReg();
    },
    saveReg: function(){
      jQuestion('Confirma os dados digitados?', 'Atenção', function(r) {
          if (r) {
              var formData = new FormData($("#form1")[0]);
              var url = "application/views/produto/grupo/ajax/grupo_addupdt_ajax.php";
              //
              $.ajax({
                  type: 'POST',
                  dataType: 'text',
                  ...
                  success: function(txt, textStatus) {
                      ...
                      try {
                          ...
                          msg = txt;
                          id = 'grupo_descricao'; // Primeira caixa de texto
                      }
                      if (msg == "OK") {
