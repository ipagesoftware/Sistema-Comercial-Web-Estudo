<?php
    ...
    */
    ...
    require_once "class/FabricanteIndex.php";  
    //
    $layout       = new App\Layout\LayoutClass();
    $navBarHeader = $layout->topHeader();
    $menuLateral  = $layout->menuLateral('FABRICANTE', 4); 
    //////////////////////////////////////////////////////////
    $FabricanteIndex = new FabricanteIndex($nivel);
    $FabricanteIndex->decodificaCriterio(); 
    // Verifica solicitações de ativação/desativação    
    $FabricanteIndex->atvDtv();
    $FabricanteIndex->getSort(); 
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body data-criterio = "" data-right-button="<?= NO_RIGHT_MOUSE_BUTTON ?>" data-url="<?= URL ?>" data-accesskey ="<?= ACCESS_KEY ?>" data-acentuacao ="<?= ACENTUACAO ?>">
  ...
  <div id="wrapper" <?php echo($layout->paddingLeft); ?>>
      ...
      <div id="page-wrapper">
          <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Lista Fabricante  <small> - <?php echo($layout->sid->getNode('procedencia_empresa'));?> </small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <i class="fa fa-refresh"></i> <a href="fabricante/">Atualizar</a>
                        </li>
                        <li>
                        ...
                        <li>
                        <?php
                          if($FabricanteIndex->permission['inserir']!=1){
                            echo('<i class="fa fa-ban"></i> Adicionar</a>'); 
                          }else{
                            echo('<i class="fa fa-plus"></i> <a href="fabricante/addupdt/' . $layout->getParameter() .'">Adicionar</a>');
                          }
                        ?>
                        </li>                        
                    </ol>
            ...
            <div class="row">
                <div class="col-lg-12">                                         
                  <?php echo($FabricanteIndex->insertDataIntoTable()); ?>
                </div>                
            </div>
            <!-- /.row -->
          </div>
  ...
  <!-- //-->
  <script src="application/views/produto/fabricante/js/FabricanteIndex.js" type="text/javascript"></script>
</body>
</html>
