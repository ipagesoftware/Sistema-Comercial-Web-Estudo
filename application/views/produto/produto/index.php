...
<body data-criterio = "" data-right-button="<?= NO_RIGHT_MOUSE_BUTTON ?>" data-url="<?= URL ?>" data-accesskey ="<?= ACCESS_KEY ?>" data-acentuacao ="<?= ACENTUACAO ?>">
  ...
  <div id="wrapper" <?php echo($layout->paddingLeft); ?>>
      ...
      <div id="page-wrapper">
          <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        Lista de Produto <small> - <?php echo($Produto->sid->getNode('procedencia_empresa')); ?></small>
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <i class="fa fa-refresh"></i> <a href="produto/">Atualizar</a>
                        </li>
                        <li>
                        ...
                        <li>
                        <?php
                          if($Produto->permission['inserir']!=1){
                            echo('<i class="fa fa-ban"></i> Adicionar</a>'); 
                          }else{
                            echo('<i class="fa fa-plus"></i> <a href="produto/addupdt/' . $layout->getParameter() . '">Adicionar</a>');
                          }
                        ?>
                        </li>                        
                    </ol>
            ...
            <div class="row">
                <div class="col-lg-12">                                         
                  <?php echo($Produto->insertDataIntoTable()); ?>
                </div>                
            </div>
            <!-- /.row -->
          </div>
  ...
  <!-- //--> 
  <script src="application/views/produto/produto/js/ProdutoIndex.js" type="text/javascript"></script>
</body>
</html>
