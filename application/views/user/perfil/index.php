...
<body data-criterio = "" data-right-button="<?= NO_RIGHT_MOUSE_BUTTON ?>" data-url="<?= URL ?>" data-accesskey ="<?= ACCESS_KEY ?>" data-acentuacao ="<?= ACENTUACAO ?>">
  ...
  <div id="wrapper" <?php echo($layout->paddingLeft); ?>>
      ...
      <div id="page-wrapper">
          <div class="container-fluid">
              <!-- Page Heading -->
              <?php
                echo($Perfil->createLinkMenu());
              ?>              
              <!-- /.row -->
              <div class="row">
                    <div class="col-sm-12">
                      <form action="application/views/user/perfil/ajax/perfil.upload.ajax.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                        <!-- //-->
                        <div class="row">
                          <div class="col-sm-3">
                            <?php
                              echo('<p><strong>Nome:</strong> ' . $Perfil->user_login . '</p>');
                              echo('<p><strong>Usuário:</strong> ' . $Perfil->user_nivel . '</p>');
                              echo('<p><strong>Email:</strong> ' . $Perfil->user_email . '</p>');                              
                            ?>
                           <div class="row">
                              <div  class="fileUpload btn btn-primary">
                                <span>Selecionar imagem</span>
                                <input type="file"  class="upload" name="fileUpload" id="fileUpload" width="10"><br />
                                <input type="hidden"  name="user_id" id="user_id" value="<?php echo($Perfil->criterio); ?>">                            
                              </div>
                            </div>                          
                          </div>
                          <div class="col-sm-6">                          
                            <div class="form-group">
                              <img src="application/views/user/perfil/foto/<?php echo($Perfil->user_foto); ?>" class="foto-perfil" id="user_foto"/><br />
  ...
  <!-- //-->
  <script src="application/views/user/perfil/js/PerfilIndex.js" type="text/javascript"></script>
</body>
</html>
