<?php
  ...
  */
  ...
  require_once "class/VendedorClienteIndex.php";
  //
  $layout       = new App\Layout\LayoutClass();
  $navBarHeader = $layout->topHeader();
  $menuLateral  = $layout->menuLateral('VENDEDOR_CLIENTE', 1); 
  //////////////////////////////////////////////////////////
  $VendedorCliente = new VendedorClienteIndex($nivel);
  $cbo_vendedor = $VendedorCliente->loadVendedorIntoComboBox();
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body data-criterio = "" data-right-button="<?= NO_RIGHT_MOUSE_BUTTON ?>" data-url="<?= URL ?>" data-accesskey ="<?= ACCESS_KEY ?>" data-acentuacao ="<?= ACENTUACAO ?>">
              ...
              <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ol class="breadcrumb">
                        ...
                        <li>
                            <i class="fa fa-refresh"></i> <a href="vendedor_cliente/">Atualizar</a>
                        </li>                                              
                        <li>
                  ...
                  <div class="col-md-9 col-md-offset-1">
                    <form class="form-horizontal" method="post" name="form1" id="form1">
                        ...
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="cbo_vendedor">* Vendedor:</label>
                          <div class="col-md-6">                          
                            <select id="cbo_vendedor" name="cbo_vendedor" class="form-control">
                            <?php echo($cbo_vendedor); ?> 
                            </select>
                          </div>
                        </div>                    
                        <!-- List1 -->
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="list1">* Cliente à Associar:</label>
                          <div class="col-md-6">
                        ...
                        <!-- List2 -->
                        <div class="form-group">
                          <label class="col-md-4 control-label" for="list2">* Cliente(s) Associado(s):</label>
                          <div class="col-md-6">
  ...
  <!-- //-->
  <script src="application/views/cadastros/vendedor_cliente/js/VendedorClienteIndex.js" type="text/javascript"></script>
</body>
</html>
