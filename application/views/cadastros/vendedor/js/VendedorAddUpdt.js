...
$(document).ready(function() {
    VendedorAddUpdt.init();
});
var VendedorAddUpdt = function() {
    // variáveis privadas
    ...
    var handleTab = function() {
        ...
        $('form #tabs a').click(function(e) {
            ...
            if (aba === '#TAB_1_1') {
                $('#vendedor_fone1').focus();
            } else if (aba === '#TAB_1_2') {
                $('#vendedor_cpf').focus();
            } else if (aba === '#TAB_1_3') {
                $('#vendedor_razao_social').focus();
            } else {
                $('#vendedor_obs').focus();
            }
        });
    ...
    var saveReg = function() {
        jQuestion('Confirma os dados digitados?', 'Atenção', function(r) {
            if (r) {
                var url = "application/views/cadastros/vendedor/ajax/vendedor_addupdt_ajax.php";
                ...
                $.ajax({
                    ...
                    success: function(txt, textStatus) {
                        ...
                        try {
                            ...
                            msg = txt;
                            id = 'vendedor_nome'; // Primeira caixa de texto
                        }
                        if (msg == "OK") {
    ...
    return {
        init: function() {
            ...
            $("#form1").attr("action", "javascript:VendedorAddUpdt.submitForm();void(0);");
