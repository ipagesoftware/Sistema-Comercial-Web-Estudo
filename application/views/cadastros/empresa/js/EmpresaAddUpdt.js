...
var EmpresaAddUpdt = function() {
    ...
    var saveReg = function() {
        jQuestion('Confirma os dados digitados?', 'Atenção', function(r) {
            if (r) {
                var url = "application/views/cadastros/empresa/ajax/empresa_addupdt_ajax.php";
                ...
                $.ajax({
                    ...
                    success: function(txt, textStatus) {
                        ...
                        try {
                            ...
                            msg = txt;
                            id = 'empresa_nome'; // Primeira caixa de texto
                        }
                        if (msg == "OK") {
    ...
    return {
        init: function() {
            ...
            $("#form1").attr("action", "javascript:EmpresaAddUpdt.submitForm();void(0);");
