            ...
            <fieldset>
                ...
                <table border="1" class="column">
                    <tr>
                        ...
                        <td class="colrite">
                            <input type="text" autocomplete="off"  id="From_Name" name="From_Name" value="<?php echo $from_name; ?>"
                    ...
                    <tr>
                        ...
                        <td class="colrite">
                            <input type="text" autocomplete="off"  id="From_Email" name="From_Email" value="<?php echo $from_email; ?>"
                    ...
                    <tr>
                        ...
                        <td class="colrite">
                            <input type="text" autocomplete="off"  id="To_Name" name="To_Name" value="<?php echo $to_name; ?>"
                    ...
                    <tr>
                        ...
                        <td class="colrite">
                            <input type="text" autocomplete="off"  id="To_Email" name="To_Email" value="<?php echo $to_email; ?>"
                    ...
                    <tr>
                        ...
                        <td class="colrite">
                            <input type="text" autocomplete="off"  id="cc_Email" name="cc_Email" value="<?php echo $cc_email; ?>"
                    ...
                    <tr>
                        ...
                        <td class="colrite">
                            <input type="text" autocomplete="off"  id="bcc_Email" name="bcc_Email" value="<?php echo $bcc_email; ?>"
                    ...
                    <tr>
                        ...
                        <td class="colrite">
                            <input type="text" autocomplete="off"  name="Subject" id="Subject" value="<?php echo $subject; ?>"
    ...
    echo "display: none;";
                    ...
                    <table border="1" class="column">
                        ...
                        <tr>
                            ...
                            <td class="colrite">
                                <input type="text" autocomplete="off"  id="smtp_server" name="smtp_server"
                        ...
                        <tr>
                            ...
                            <td class="colrite">
                                <input type="text" autocomplete="off"  name="smtp_port" id="smtp_port" size="3"
...
<?php if ($smtp_authenticate != '') {
    echo "checked";
                        ...
                        <tr>
                            ...
                            <td class="colrite">
                                <input type="text" autocomplete="off"  id="authenticate_username" name="authenticate_username"
